...
static META_ATTRIBUTE class_atts[] = {
  ...
  {"real_oid", DB_TYPE_OBJECT, 1, "object", 0, 0, NULL},
  {"real_heap_fileid", DB_TYPE_INTEGER, 0, NULL, 0, 0, NULL},
  {"real_heap_volid", DB_TYPE_INTEGER, 0, NULL, 0, 0, NULL},
  {"real_heap_pageid", DB_TYPE_INTEGER, 0, NULL, 0, 0, NULL},
  {"name", DB_TYPE_STRING, 1, NULL, 0, 0, NULL},
  ...
  {"triggers", DB_TYPE_SET, 1, "object", 0, 0, NULL},
  {"properties", DB_TYPE_SET, 0, NULL, 0, 0, NULL},
  {"node_name", DB_TYPE_STRING, 1, NULL, 0, 0, NULL},
  {NULL, (DB_TYPE) 0, 0, NULL, 0, 0, NULL}
};
...
static CT_ATTR ct_class_atts[] = {
  ...
  {"is_global", NULL_ATTRID, DB_TYPE_INTEGER},
  {"node_name", NULL_ATTRID, DB_TYPE_VARCHAR}
};
...
#define SET_CT_CLS(name, n_atts, atts) \
        {CT_CLASS_NAME, {NULL_PAGEID, NULL_SLOTID, NULL_VOLID}, 22, ct_class_atts};

CT_CLASS ct_Class =
  { CT_CLASS_NAME, {NULL_PAGEID, NULL_SLOTID, NULL_VOLID}, 22,
ct_class_atts
};
...
CT_CLASS ct_Index =
  { CT_INDEX_NAME, {NULL_PAGEID, NULL_SLOTID, NULL_VOLID}, 10,
  ct_index_atts };
