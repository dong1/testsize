...
/* cluster functions */
extern bool sm_is_global_class (MOP op);
extern HFID *sm_get_real_hfid (MOP op);
extern OID *sm_get_real_oid (MOP op);
extern const char *sm_get_node_name (MOP op);
extern HFID *sm_real_hfid (MOBJ classobj);
extern OID *sm_real_oid (MOBJ classobj);
extern const char *sm_node_name (MOBJ classobj);
extern bool sm_set_remote (MOP op, int node);
extern int sm_get_remote_info_if_need (MOP classop);
extern int sm_sync_global_schema (MOP classop, unsigned int remote_node);
