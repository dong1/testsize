...
#define ER_CCF_NODE_NAME_TOO_LONG                   -1022
#define ER_CCF_HOST_NAME_TOO_LONG                   -1023
#define ER_CCF_INVALID_HOST_ADDRESS                 -1024
#define ER_CCF_DUPLICATE_ADDRESS                    -1025
#define ER_CCF_CANT_REGISTER_OTHER_DB_FIRSTLY       -1026
#define ER_CCF_INVALID_PORT_VALUE                   -1027
#define ER_CCF_DUPLICATE_NODE                       -1028
#define ER_CCF_NOT_FIND_NODE                        -1029
#define ER_CCF_NODE_NOT_EMPTY                       -1030
#define ER_CCF_CANT_GET_CONNECTED_NODE_INFO         -1031

#define ER_LOG_2PC_MAX_NUM_PARTICIPANT_EXCEEDED     -1032

#define ER_MAX_CLUSTER_NODE_NUM_EXCEEDED            -1033

#define ER_REMOTE_SERVER_EXE_FAIL                   -1034
#define ER_REMOTE_SERVER_SCAN_FAIL                  -1035
#define ER_REMOTE_SERVER_END_FAIL                   -1036

#define ER_GET_REMOTE_SERIAL_OID_FAILED             -1037
#define ER_GET_REMOTE_SERIAL_CACHE_FAILED           -1038

#define ER_CLUSTER_OPERATION_IN_SA_MODE             -1039

#define S2S_CONN_UNEXPECT_DATATYPE                  -1040

#define ER_LAST_ERROR                               -1041
