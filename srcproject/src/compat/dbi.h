...
extern DB_OBJECT *db_find_cluster_node (const char *node_name);

extern unsigned int db_get_node_ip (DB_OBJECT * node);

extern unsigned int db_find_node_ip (const char *node);

extern int db_get_node_port (DB_OBJECT * node);

extern DB_OBJLIST *db_get_node_list (void);

extern int db_get_node_count (void);

extern bool db_is_in_cluster (void);

extern DB_OBJECT *db_get_connected_node (void);

extern const char *db_get_connected_node_name (void);

extern int db_register_cluster_node (const char *node_name,
				     const char *db_host, int cubrid_port);

extern int db_unregister_cluster_node (const char *node_name);
