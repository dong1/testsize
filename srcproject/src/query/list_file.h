...
extern void qfile_close_scan (THREAD_ENTRY * thread_p,
			      QFILE_LIST_SCAN_ID * s_id);
extern SCAN_CODE qfile_add_tuple_to_val_list (QFILE_TUPLE_VALUE_TYPE_LIST *
					      type_list_p,
					      QFILE_TUPLE tuple_record,
					      VAL_LIST * dest_val_list);
extern SCAN_CODE qfile_to_val_list (THREAD_ENTRY * thread_p,
