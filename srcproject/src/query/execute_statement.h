...
extern int do_get_serial_node_id (int *node_id, MOP serial_obj);
...
extern int do_alter_user (const PARSER_CONTEXT * parser,
			  const PT_NODE * statement);
extern int do_register_node (const PARSER_CONTEXT * parser,
			     const PT_NODE * statement);

extern int do_unregister_node (const PARSER_CONTEXT * parser,
			       const PT_NODE * statement);

extern int do_schema_sync (const PARSER_CONTEXT * parser,
			   const PT_NODE * statement);
