...
enum pt_node_type
{
  ...
  PT_REGISTER_NODE = CUBRID_STMT_REGISTER,	/* for register command */
  PT_UNREGISTER_NODE = CUBRID_STMT_UNREGISTER,	/* for unregister command */

  PT_SCHEMA_SYNC = CUBRID_STMT_SCHEMA_SYNC,
...
typedef enum
{
  ...
  PT_LOCAL_CHECK_OPT,		/* local or cascaded view check option */
  ...
  PT_GLOBAL			/* entity in global schema, e.g. global table */
} PT_MISC_TYPE;
...
typedef struct pt_register_node_info PT_REGISTER_NODE_INFO;
...
typedef struct pt_schema_sync_info PT_SCHEMA_SYNC_INFO;
...
struct pt_alter_info
{
  ...
  PT_MISC_TYPE global_entity;	/* enum 0 or PT_GLOBAL */
};
...
struct pt_create_entity_info
{
  ...
  PT_MISC_TYPE with_check_option;	/* 0, PT_LOCAL_CHECK_OPT, or PT_CASCADED_CHECK_OPT */
  PT_NODE *entity_name;		/* PT_NAME */
  ...
  PT_HINT_ENUM hint;		/* hint flag */
  PT_MISC_TYPE global_entity;	/* enum 0 or PT_GLOBAL */
  PT_NODE *on_node;		/* PT_VALUE (string) */
};
...
struct pt_partition_info
{
  ...
  PT_NODE *hashsize;
  PT_NODE *parts;		/* PT_PARTS_INFO list */
  PT_NODE *on_node;		/* PT_VALUE (or list) */
  int nodesize;			/* the count of nodes */
...
/* REGISTER NODE or UNREGISTER NODE */
struct pt_register_node_info
{
  PT_NODE *on_node;		/* PT_VALUE (string) */
  PT_NODE *host_name;		/* PT_VALUE (string) */
  PT_NODE *port;		/* PT_VALUE (int) */
};
...
/* Info for SYNC NODE */
struct pt_schema_sync_info
{
  PT_NODE *node_name;		/* PT_VALUE (string) */
};
...
union pt_statement_info
{
  ...
  PT_QUERY_INFO query;
  PT_REGISTER_NODE_INFO register_node;
  ...
  PT_SCOPE_INFO scope;
  PT_SCHEMA_SYNC_INFO schema_sync;
