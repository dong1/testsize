...
#define MSGCAT_SYNTAX_MISSING_GLOABL_KEYWORD		MSGCAT_SYNTAX_NO(91)
...
#define MSGCAT_SEMANTIC_CANNOT_FIND_RELATIVE_NODE       MSGCAT_RUNTIME_NO(211)
#define MSGCAT_SEMANTIC_CANNOT_FIND_CONNECTED_NODE      MSGCAT_RUNTIME_NO(212)
#define MSGCAT_SEMANTIC_CANNOT_FIND_NODE                MSGCAT_RUNTIME_NO(213)
#define MSGCAT_SEMANTIC_NODE_CODE_LARGE_THAN_PARTITION_CODE	MSGCAT_RUNTIME_NO(214)
#define MSGCAT_SEMANTIC_NOT_SUPPORT_RANGE_AND_LIST	MSGCAT_RUNTIME_NO(215)
#define MSGCAT_SEMANTIC_LACK_OF_GLOBAL_KEYWORD		MSGCAT_RUNTIME_NO(216)
#define MSGCAT_SEMANTIC_CANNOT_ADD_GLOBAL_KEYWORD	MSGCAT_RUNTIME_NO(217)
#define MSGCAT_SEMANTIC_DELETE_LOCAL_AND_GLOBAL_NOT_ALLOWED	MSGCAT_RUNTIME_NO(218)
#define MSGCAT_SEMANTIC_NOT_SUPPORT_GLOBAL_VIEW		MSGCAT_RUNTIME_NO(219)
#define MSGCAT_SEMANTIC_MORE_THAN_ONE_NODE		MSGCAT_RUNTIME_NO(220)
#define MSGCAT_SEMANTIC_GLOBAL_SERIAL_NEED_CACHE	MSGCAT_RUNTIME_NO(221)
#define MSGCAT_SEMANTIC_GLOBAL_JOIN			MSGCAT_RUNTIME_NO(222)
#define MSGCAT_SEMANTIC_GLOBAL_SUBQUERY			MSGCAT_RUNTIME_NO(223)
#define MSGCAT_SEMANTIC_NOT_SUPPORT_OO			MSGCAT_RUNTIME_NO(224)
#define MSGCAT_SEMANTIC_NOT_SUPPORT_ALTER_PARTITION	MSGCAT_RUNTIME_NO(225)
#define MSGCAT_SEMANTIC_NOT_SUPPORT_FOREIGN_KEY		MSGCAT_RUNTIME_NO(226)
#define MSGCAT_SEMANTIC_NOT_SUPPORT_LIKE_AS		MSGCAT_RUNTIME_NO(227)
#define MSGCAT_SEMANTIC_UNIQUE_WITHOUT_PARTITION_KEY    MSGCAT_RUNTIME_NO(228)
#define MSGCAT_SEMANTIC_NOT_SUPPORT_GROUPBY_HAVING	MSGCAT_RUNTIME_NO(229)
#define MSGCAT_SEMANTIC_NOT_SUPPORT_INSERT_ON_DUPLICATE	MSGCAT_RUNTIME_NO(230)
#define MSGCAT_SEMANTIC_NOT_SUPPORT_UPDATE_PARTITION_KEY	MSGCAT_RUNTIME_NO(231)
#define MSGCAT_SEMANTIC_NOT_SUPPORT_REPLACE		MSGCAT_RUNTIME_NO(232)
#define MSGCAT_SEMANTIC_NOT_SUPPORT_TRUNCATE		MSGCAT_RUNTIME_NO(233)
#define MSGCAT_SEMANTIC_CLUSTER_NOT_SUPPORT_SA_MODE	MSGCAT_RUNTIME_NO(234)
#define MSGCAT_SEMANTIC_NOT_SUPPORT_GLOBAL_TRIGGER	MSGCAT_RUNTIME_NO(235)
#define MSGCAT_SEMANTIC_LOCAL_TABLE_NOT_USE_GLBAL_TABLE	MSGCAT_RUNTIME_NO(236)
#define MSGCAT_SEMANTIC_NOT_SUPPORT_CONNECT_BY		MSGCAT_RUNTIME_NO(237)
#define MSGCAT_SEMANTIC_NOT_AUTO_INCREMENT		MSGCAT_RUNTIME_NO(238)
#define MSGCAT_SEMANTIC_NOT_SUPPORT_UPDATE_WITH_SUBQUERY	MSGCAT_RUNTIME_NO(239)
#define MSGCAT_SEMANTIC_NOT_SUPPORT_DELETE_WITH_SUBQUERY	MSGCAT_RUNTIME_NO(240)
