...
static PT_NODE *pt_apply_prepare_to_commit (PARSER_CONTEXT * parser,
					    PT_NODE * p, PT_NODE_FUNCTION g,
					    void *arg);
static PT_NODE *pt_apply_register_node (PARSER_CONTEXT * parser, PT_NODE * p,
					PT_NODE_FUNCTION g, void *arg);
...
static PT_NODE *pt_apply_spec (PARSER_CONTEXT * parser, PT_NODE * p,
			       PT_NODE_FUNCTION g, void *arg);
static PT_NODE *pt_apply_schema_sync (PARSER_CONTEXT * parser, PT_NODE * p,
				      PT_NODE_FUNCTION g, void *arg);
...
static PT_NODE *pt_init_register_node (PT_NODE * p);
...
static PT_NODE *pt_init_schema_sync (PT_NODE * p);
...
static PARSER_VARCHAR *pt_print_prepare_to_commit (PARSER_CONTEXT * parser,
						   PT_NODE * p);
static PARSER_VARCHAR *pt_print_register_node (PARSER_CONTEXT * parser,
					       PT_NODE * p);
...
static PARSER_VARCHAR *pt_print_sp_parameter (PARSER_CONTEXT * parser,
					      PT_NODE * p);
static PARSER_VARCHAR *pt_print_schema_sync (PARSER_CONTEXT * parser,
					     PT_NODE * p);
...
pt_init_apply_f (void)
{
  ...
  pt_apply_func_array[PT_REGISTER_NODE] = pt_apply_register_node;
  ...
  pt_apply_func_array[PT_SCHEMA_SYNC] = pt_apply_schema_sync;
  ...
  pt_apply_func_array[PT_UNREGISTER_NODE] = pt_apply_register_node;
...
pt_init_init_f (void)
{
  ...
  pt_init_func_array[PT_REGISTER_NODE] = pt_init_register_node;
  ...
  pt_init_func_array[PT_SCHEMA_SYNC] = pt_init_schema_sync;
  ...
  pt_init_func_array[PT_UNREGISTER_NODE] = pt_init_register_node;
...
pt_init_print_f (void)
{
  ...
  pt_print_func_array[PT_REGISTER_NODE] = pt_print_register_node;
  ...
  pt_print_func_array[PT_SCHEMA_SYNC] = pt_print_schema_sync;
  ...
  pt_print_func_array[PT_UNREGISTER_NODE] = pt_print_register_node;
...
pt_currency_to_db (const PT_CURRENCY t)
{
  switch (t)
    ...
    case PT_CURRENCY_YUAN:
      return DB_CURRENCY_YUAN;
...
pt_print_alter (PARSER_CONTEXT * parser, PT_NODE * p)
{
  ...
  if (p->info.alter.global_entity == PT_GLOBAL)
    {
...
pt_print_alter_index (PARSER_CONTEXT * parser, PT_NODE * p)
{
  ...
  if (p->info.index.global_entity == PT_GLOBAL)
    {
      b = pt_append_nulstring (parser, b, " global");
    }
...
pt_print_alter_user (PARSER_CONTEXT * parser, PT_NODE * p)
{
  ...
  b = pt_append_nulstring (parser, b, "alter ");
  if (p->info.alter_user.global_entity == PT_GLOBAL)
    {
      b = pt_append_nulstring (parser, b, "global ");
    }
  b = pt_append_nulstring (parser, b, "user ");
  b = pt_append_varchar (parser, b, r1);
			...
			PT_NODE_FUNCTION g, void *arg)
{
  ...
  p->info.create_entity.on_node =
    g (parser, p->info.create_entity.on_node, arg);
  return p;
}
...
pt_print_create_entity (PARSER_CONTEXT * parser, PT_NODE * p)
{
  ...
  if (p->info.create_entity.global_entity == PT_GLOBAL)
    {
      q = pt_append_nulstring (parser, q, "global ");
    }
  q = pt_append_nulstring (parser, q,
  ...
  if (p->info.create_entity.global_entity == PT_GLOBAL
      && p->info.create_entity.on_node)
    {
      r1 = pt_print_bytes (parser, p->info.create_entity.on_node);
      q = pt_append_nulstring (parser, q, " on node ");
      q = pt_append_varchar (parser, q, r1);
    }
...
pt_print_create_user (PARSER_CONTEXT * parser, PT_NODE * p)
{
  ...
  b = pt_append_nulstring (parser, b, "create");
  if (p->info.create_user.global_entity == PT_GLOBAL)
    {
      b = pt_append_nulstring (parser, b, " global");
    }
  b = pt_append_nulstring (parser, b, " user ");
		    ...
		    PT_NODE_FUNCTION g, void *arg)
{
  ...
  if (p->info.partition.type == PT_PARTITION_HASH)
	...
	g (parser, p->info.partition.hashsize, arg);
      p->info.partition.on_node = g (parser, p->info.partition.on_node, arg);
    }
  else
    {
  ...
  if (p->info.partition.type == PT_PARTITION_HASH)
    {
      ...
      r3 = pt_print_bytes_l (parser, p->info.partition.on_node);
    }
  else
    {
...
pt_print_create_serial (PARSER_CONTEXT * parser, PT_NODE * p)
{
  ...
  q = pt_append_nulstring (parser, q, "create");
  if (p->info.serial.global_entity == PT_GLOBAL)
    {
      q = pt_append_nulstring (parser, q, " global");
    }
  q = pt_append_nulstring (parser, q, " serial ");
  q = pt_append_varchar (parser, q, r1);
  ...
  if (p->info.serial.global_entity == PT_GLOBAL && p->info.serial.on_node)
    {
      r1 = pt_print_bytes (parser, p->info.serial.on_node);
      q = pt_append_nulstring (parser, q, " on node ");
      q = pt_append_varchar (parser, q, r1);
    }
...
pt_print_drop_serial (PARSER_CONTEXT * parser, PT_NODE * p)
{
  ...
  if (p->info.serial.global_entity == PT_GLOBAL)
    {
      pt_append_nulstring (parser, q, "global ");
    }
  q = pt_append_nulstring (parser, q, "serial ");
  q = pt_append_varchar (parser, q, r1);
			...
			PT_NODE_FUNCTION g, void *arg)
{
  ...
  p->info.serial.on_node = g (parser, p->info.serial.on_node, arg);
  return p;
}
...
pt_print_drop (PARSER_CONTEXT * parser, PT_NODE * p)
{
  ...
  q = pt_append_nulstring (parser, q, "drop ");
  if (p->info.drop.global_entity == PT_GLOBAL)
    {
      q = pt_append_nulstring (parser, q, "global ");
    }
  q = pt_append_varchar (parser, q, r1);
...
pt_print_drop_user (PARSER_CONTEXT * parser, PT_NODE * p)
{
  ...
  b = pt_append_nulstring (parser, b, "drop ");
  if (p->info.drop_user.global_entity == PT_GLOBAL)
    {
      b = pt_append_nulstring (parser, b, "global ");
    }
  b = pt_append_nulstring (parser, b, "user ");
 ...
 */
static PT_NODE *
pt_apply_register_node (PARSER_CONTEXT * parser, PT_NODE * p,
			PT_NODE_FUNCTION g, void *arg)
{
  p->info.register_node.on_node =
    g (parser, p->info.register_node.on_node, arg);
  p->info.register_node.host_name =
    g (parser, p->info.register_node.host_name, arg);
  p->info.register_node.port = g (parser, p->info.register_node.port, arg);
  return p;
}

/*
 * pt_init_register_node () -
 *   return:
 *   p(in):
 */
static PT_NODE *
pt_init_register_node (PT_NODE * p)
{
  p->info.register_node.on_node = NULL;
  p->info.register_node.host_name = NULL;
  p->info.register_node.port = NULL;
  return p;
}

/*
 * pt_print_register_node () -
 *   return:
 *   parser(in):
 *   p(in):
 */
static PARSER_VARCHAR *
pt_print_register_node (PARSER_CONTEXT * parser, PT_NODE * p)
{
  PARSER_VARCHAR *q = 0, *r1, *r2, *r3;

  r1 = pt_print_bytes (parser, p->info.register_node.on_node);
  if (PT_REGISTER_NODE == p->node_type)
    {
      q = pt_append_nulstring (parser, q, "register node ");
    }
  else
    {
      q = pt_append_nulstring (parser, q, "unregister node ");
    }
  q = pt_append_varchar (parser, q, r1);

  if (p->info.register_node.host_name != NULL)
    {
      r2 = pt_print_bytes (parser, p->info.register_node.host_name);
      q = pt_append_nulstring (parser, q, " ");
      q = pt_append_varchar (parser, q, r2);
    }

  if (p->info.register_node.port != NULL)
    {
      r3 = pt_print_bytes (parser, p->info.register_node.port);
      q = pt_append_nulstring (parser, q, " ");
      q = pt_append_varchar (parser, q, r3);
    }
...
pt_print_rename (PARSER_CONTEXT * parser, PT_NODE * p)
{
  ...
  if (p->info.rename.global_entity == PT_GLOBAL)
    {
      b = pt_append_nulstring (parser, b, "global ");
    }
  b = pt_append_nulstring (parser, b,
...
*/
static PT_NODE *
pt_apply_schema_sync (PARSER_CONTEXT * parser, PT_NODE * p,
		      PT_NODE_FUNCTION g, void *arg)
{
  p->info.schema_sync.node_name =
    g (parser, p->info.schema_sync.node_name, arg);
  return p;
}
...
*/
static PT_NODE *
pt_init_schema_sync (PT_NODE * p)
{
  p->info.schema_sync.node_name = NULL;
  return p;
}

/*
* pt_print_schema_sync () -
*   return:
*   parser(in):
*   p(in):
*/
static PARSER_VARCHAR *
pt_print_schema_sync (PARSER_CONTEXT * parser, PT_NODE * p)
{
  PARSER_VARCHAR *q = 0, *r1;

  r1 = pt_print_bytes (parser, p->info.schema_sync.node_name);
  q = pt_append_nulstring (parser, q, "schema_sync ");
  q = pt_append_varchar (parser, q, r1);
