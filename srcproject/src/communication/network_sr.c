...
net_server_init (void)
{
  ...
  net_Requests[NET_SERVER_SERIAL_GET_REAL_OID].action_attribute =
    IN_TRANSACTION;
  net_Requests[NET_SERVER_SERIAL_GET_REAL_OID].processing_function =
    sserial_get_real_oid;
  net_Requests[NET_SERVER_SERIAL_GET_REAL_OID].name =
    "NET_SERVER_SERIAL_GET_REAL_OID";

  net_Requests[NET_SERVER_SERIAL_GET_CACHE_RANGE].action_attribute =
    CHECK_DB_MODIFICATION | IN_TRANSACTION;
  net_Requests[NET_SERVER_SERIAL_GET_CACHE_RANGE].processing_function =
    sserial_get_cache_range;
  net_Requests[NET_SERVER_SERIAL_GET_CACHE_RANGE].name =
    "NET_SERVER_SERIAL_GET_CACHE_VALUE";
...
net_server_start (const char *server_name)
{
  ...
  css_net_set_database_name (server_name);
