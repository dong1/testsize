...
enum net_server_request
{
  ...
  NET_SERVER_SERIAL_GET_CACHE_RANGE,
  ...
  /*
   * This command is special command, it will be handle at read_and_queue
   * it is used to set packet router path, the function is design for 
   * controlling multiple server at broker
   */
  NET_PROXY_SET_ROUTER,
