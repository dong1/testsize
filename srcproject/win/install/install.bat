...
set MSG_GBCN_DIR=%DEST_DIR%\msg\zh_CN.gb2312
set MSG_UTFCN_DIR=%DEST_DIR%\msg\zh_CN.utf8
...
copy %SRC_DIR%\..\..\..\msg\zh_CN.gb2312\*.msg 	%MSG_GBCN_DIR%
copy %SRC_DIR%\..\..\..\msg\zh_CN.gb2312\syntax.txt 	%MSG_GBCN_DIR%
copy %SRC_DIR%\..\..\..\msg\zh_CN.utf8\*.msg 	%MSG_UTFCN_DIR%
copy %SRC_DIR%\..\..\..\msg\zh_CN.utf8\syntax.txt 	%MSG_UTFCN_DIR%

echo on
for %%f in (%MSG_EN_US_DIR%,%MSG_EUCKR_DIR%,%MSG_UTFKR_DIR%,%MSG_GBCN_DIR%,%MSG_UTFCN_DIR%) do "%GENCAT%" "%%f\csql.cat" "%%f\csql.msg"
for %%f in (%MSG_EN_US_DIR%,%MSG_EUCKR_DIR%,%MSG_UTFKR_DIR%,%MSG_GBCN_DIR%,%MSG_UTFCN_DIR%) do "%GENCAT%" "%%f\cubrid.cat" "%%f\cubrid.msg"
for %%f in (%MSG_EN_US_DIR%,%MSG_EUCKR_DIR%,%MSG_UTFKR_DIR%,%MSG_GBCN_DIR%,%MSG_UTFCN_DIR%) do "%GENCAT%" "%%f\esql.cat" "%%f\esql.msg"
for %%f in (%MSG_EN_US_DIR%,%MSG_EUCKR_DIR%,%MSG_UTFKR_DIR%,%MSG_GBCN_DIR%,%MSG_UTFCN_DIR%) do "%GENCAT%" "%%f\utils.cat" "%%f\utils.msg"
